...
exports.sendTransactionInvoiceEmail = exports.sendPasswordResetEmail = exports.sendWelcomeEmail = void 0;
const nodemailer_1 = __importDefault(require("nodemailer"));
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
function getLogoPath() {
    const possiblePaths = [
        path_1.default.join(process.cwd(), 'assets/nfs-logo.png'),
        path_1.default.join(process.cwd(), 'src/assets/nfs-logo.png'),
        path_1.default.join(__dirname, '../assets/nfs-logo.png'),
        path_1.default.join(__dirname, '../../assets/nfs-logo.png'),
    ];
...
const sendWelcomeEmail = (userEmail, userName, plainPassword) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let transporter;
      ...
      `,
        ...
        if (info.messageId && nodemailer_1.default.getTestMessageUrl) {
            console.log('👉 Voir l\'email généré : %s', nodemailer_1.default.getTestMessageUrl(info));
        }
    }
    catch (error) {
...
const sendPasswordResetEmail = (userEmail, userName, plainPassword) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let transporter;
        if (process.env.SMTP_HOST && process.env.SMTP_USER) {
            transporter = nodemailer_1.default.createTransport({
      ...
      `,
        ...
        if (info.messageId && nodemailer_1.default.getTestMessageUrl) {
            console.log('Voir l email genere : %s', nodemailer_1.default.getTestMessageUrl(info));
        }
    }
    catch (error) {
...
function resolveReceiptSubtitle(titleStr) {
...
const sendTransactionInvoiceEmail = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let transporter;
        if (process.env.SMTP_HOST && process.env.SMTP_USER) {
            transporter = nodemailer_1.default.createTransport({
    ...
    `;
        ...
        if (info.messageId && nodemailer_1.default.getTestMessageUrl) {
            console.log('👉 [Ethereal Mail Test Link]: %s', nodemailer_1.default.getTestMessageUrl(info));
        }
    }
    catch (error) {
...
exports.sendTransactionInvoiceEmail = sendTransactionInvoiceEmail;
